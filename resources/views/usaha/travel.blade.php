...
@section('container')
    ...
    <div class=" my-10">
      <div class="w-full">
        ...
        <div class="lg:w-[50%] container  mx-auto">
          <h2 class="text-secondry text-2xl sm:text-3xl font-bold font-[Poppins] my-3 text-center">Kami menyediakan layanan yang dapat membantu anda</h2>
        </div>
  ...
  <section id="travel-content" class=" bg-cover bg-center h-[1000px] sm:h-[1700px] md:h-[1900px] lg:h-[600px] " style="background-image: url('img/10.jpg')">
    <div class="w-full h-full flex items-center opacity-white backdrop-blur-sm p-5">
      <div class="container ">
      <div class="conten flex justify-center flex-wrap lg:flex-nowrap  h-full items-center">
        @foreach ($travel as $item)
        <div class=" relative overflow-hidden card-trav w-full h-full p-4  mr-4 md:mr-0 lg:basis-1/3 group">
          <a href="travel/{{ $item['slug'] }}" class="relative group">
            <img src="img/{{ $item['gambar'] }}" alt="" class="w-full h-full group-hover:scale-110 duration-300 transition-all">
            <div class=" right-0 left-0 absolute top-0 opacity-rgba w-full h-full group-hover:scale-75 duration-300 transition-all">
              <div class="w-full flex justify-center my-12 text-center  flex-col h-[40%] md:h-[50%] font-[Poppins]">
                <h2 class="text-white text-xl  md:text-3xl my-4 font-bold">{{ $item['title'] }}</h2>
              </div>
            </div>
          </a>
        </div>
