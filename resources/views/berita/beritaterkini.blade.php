...
@section('container')
 <!-- hero section start -->
    ...
    <section id="#sejarah" class="p-8  -mt-[25rem] sm:-mt-[23rem] md:-mt-[13rem] lg:-mt-[10rem]">
      <div class="container">
        <div class="w-full">
          <div class="flex border  -mt-20 mb-20 sm:mt-5 border-red-200 max-w-full md:w-[50%] ">
            <div class="m-2 flex">
              <span class="m-1"><i class="fa-regular fa-folder-closed" style="color: #00933f;"></i></span>
              <h2 class="m-1">tanggal</h2>
            </div>
            <div class="m-2 flex">
              <span class="m-1"><i class="bi bi-calendar "style="color: #00933f;" ></i></span>
              <h2 class="m-1">tanggal</h2>
            </div>
          </div>
