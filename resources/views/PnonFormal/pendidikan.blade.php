...
@section('container')
 <!-- hero section start -->
    ...
    <section id="#sejarah" class="p-8  -mt-[25rem] sm:-mt-[23rem] md:-mt-[13rem] lg:-mt-[10rem]">
      <div class="container">
        <div class="w-full">
          <h4 class="text-2xl font-semibold -mt-2 md:mt-6 lg:text-4xl lg:mt-5 text-secondry">{{ $Nformal["title"] }}</h4>
        ...
        <div class="container">
          <div class="w-full">
            <div class="  my-5  w-full">
              <h2 class="sejarah">Dewan Guru</h2>
              <div class=" overflow-auto hidden rounded-lg shadow-lg md:block ">    
                   <table class="w-full bg-white ">
                      <thead class="bg-gray-50 border-b-2 border-gray-200">
                          ...
                          <th class="p-3 text-sm font-semibold tracking-wide text-left ">L/P</th>
                      ...
                      <tbody>
                          ...
                          <td class="p-3 text-sm text-gray-700">L</td>
                          ...
                          <td class="p-3 text-sm text-gray-700">P</td>
                          <td class="p-3 text-sm text-gray-700">Pendiri Yayasan</td>
                          <td class="p-3 text-sm text-gray-700">Pendiri Yayasan</td>
                          </tr>
                          <tr class="bg-white">
